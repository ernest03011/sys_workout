  ...
  <nav class="bg-gray-800">
        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            ...
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/workouts" class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Workouts</a>
              <a href="/logout" class=" text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-mediu">Logout</a>
    ...
    <div class="hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
        ...
        <a href="/workouts" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Workouts</a>
